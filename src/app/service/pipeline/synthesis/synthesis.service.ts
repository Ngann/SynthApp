...
import { SynthMessage, SynthNoteOn, ClockTick, SynthNoteOff, WaveformChange } from 'src/app/models/synth-note-messsage';
import { Subject } from 'rxjs';
import { SynthNote } from 'src/app/models/synth-note';
