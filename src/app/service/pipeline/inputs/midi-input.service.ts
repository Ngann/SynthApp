...
import { SynthMessage, SynthNoteOn, SynthNoteOff, VolumeChange, WaveformChange } from 'src/app/models/synth-note-messsage';
...
export class MidiInputService {
  ...
  setup(synthStream$: Subject<SynthMessage>) {
    ...
    //disable due to error(find new approach to implement)
